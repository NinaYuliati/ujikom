...
<body>
	...
	<?php 
	$pembayaran = $koneksi -> query("SELECT tb_pembayaran.*,tb_siswa.nisn, tb_siswa.nama, tb_siswa.kelas
							FROM tb_pembayaran INNER JOIN tb_siswa ON tb_pembayaran.nisn = tb_pembayaran.nisn
